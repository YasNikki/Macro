...
public class Splash_Macro_GUI extends javax.swing.JFrame {

    public Splash_Macro_GUI() {
        initComponents();
            ...
            public void run(){
                for(int i=0;i<101;i++){
                    try {
                        ...
                        Logger.getLogger(Splash_Macro_GUI.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Splash_Macro_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Splash_Macro_GUI().setVisible(true);
            }
        });
    }

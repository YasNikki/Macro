...
public class Gastos_Macro_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botaoGastos.setBackground(new java.awt.Color(204, 204, 204));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gastos_Macro_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
